...
import { GetTimeNow } from "../../components/utils/Moment.js";
import ModalComponent from "../../components/ModalComponent/ModalComponent.jsx";
import { ErrorToast } from "../../components/utils/Toast.js";
import {
  getStorage,
    ...
    <>
      <div className="flex justify-between items-center border-b-2 border-b-gray-600 pb-5">
        <div className="flex items-center gap-x-[33px]">
          <picture className="w-32 h-32 rounded-full">
            <img src={friendsItem.profile_picture || avatar} alt={avatar} className= "w-32 h-32 rounded-full"/>
          </picture>
